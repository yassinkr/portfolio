...
const Expertise = () => {
  return (
    <div className='relative w-full  h-screen flex justify-center items-center overflow-hidden '>
      ...
      <div className='absolute bg-secondaryblue right-[-8rem] bottom-[-4rem] w-[20rem] h-[20rem] xl:w-[30rem] xl:h-[30rem] rounded-full'></div>
      <div className='absolute bg-secondaryblue left-[-8rem] bottom-[-4rem] w-[20rem] h-[20rem] xl:w-[30rem] xl:h-[30rem] rounded-full'></div>

      <div className='absolute bg-myblue right-32 xl:right-48 bottom-[-5rem] xl:bottom-[-12rem] w-56 h-56 xl:w-96 xl:h-96 rounded-full'></div>
      <div className='absolute bg-myblue left-32 xl:left-48 bottom-[-5rem] xl:bottom-[-12rem] w-56 h-56 xl:w-96 xl:h-96 rounded-full'></div>
