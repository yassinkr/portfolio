...
const LandingCatch = () => {
  ...
  return (
    ...
    <div className='bg-myblue flex justify-center lg:justify-end items-end lg:items-center text-center text-white h-screen w-full relative overflow-hidden'>
      <div style={containerStyle} className='w-[200px] h-[400px] md:w-[270px] md:h-[500px] lg:w-[330px] lg:h-[600px] left-[20%] xs:left-[30%] md:left-[36%] lg:left-[22%] 3xl:left-[490px] top-10 md:top-24 lg:top-32 xs:top-32'></div>
